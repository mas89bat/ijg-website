...
export function NewHero() {
  ...
  const STATS = [
    { value: "30+", label: t.stat_years },
    { value: "N$15B+", label: t.stat_aum },
    { value: "2,500+", label: t.stat_clients },
    { value: "100%", label: t.stat_independent },
  ];
      ...
      <div className="ijg-container" style={{ position: "relative" }}>
        <div style={{ maxWidth: "780px" }}>
          ...
          >
            {t.hero_title_1}
            <br />
            <span style={{ color: "#C9A84C" }}>{t.hero_title_2}</span>
          </h1>
          ...
          >
            ...
            >
              {t.hero_cta_services} <ArrowRight size={16} />
            </button>
          </div>
        </div>
